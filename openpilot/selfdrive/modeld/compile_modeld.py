...
# device the camera frames live on and get warped on; with a chestnut this stays QCOM so only the
# warped model input crosses USB (a full tici/tizi frame pair is ~7.5MB, ~22ms over USB 3)
